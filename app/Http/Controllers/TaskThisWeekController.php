...
class TaskThisWeekController extends Controller
{
    public function index()
    {
        ...
        $tasks = $tasks->filter(function ($task) {
            return $task->due_date_at->isCurrentWeek();
        });

        return view('this-week', ['tasks' => $tasks , 'user' => $user, 'title' => $title,'folders' => $folders,
    ...
    public function store(StoreTaskRequest $request, TaskService $taskService)
    {
        ...
        return redirect('home/this-week');
