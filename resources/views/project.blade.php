...
@section('content')
    ...
    <div class="container-xl">
            ...
            <div class="col-3 ">
                ...
                <h2 class="d-flex justify-content-center page-title">
                    ...
                    @foreach ($tasks as $task)
                        @if($task->project_id === $projectName->id)
        ...
        <div class="page-body">
            ...
            <div class="mb-3">
                <form action="{{route('create.folderTask')}}" method="POST"  >
                    @csrf
                    @if($errors->any())
                    ...
                    <span class="link-secondary">
                        ...
                        <select style="width: 100px;" name="project_id" class="form-control  link-secondary">
                            ...
                            @foreach($projects as $project)
                                <option value="{{ $project->id }}" {{ ($project->id == $projectName->id ) ? "selected"  : '' }}>{{ $project->name }}</option>
                            @endforeach
                        </select>
                    </span>
