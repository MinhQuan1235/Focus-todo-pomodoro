    ...
    <div class="container-xl">
        ...
        <div class="page-body">
            ...
            <div class="mb-3">
                <form action="{{ route('create') }}" method="POST">
                    ...
                    <div class="input-group input-group-flat ">
                        ...
                        <input name="taskname" type="text" class="form-control form-control-lg" autocomplete="off"
                            placeholder="Add a tasks to 'tasks', press [Enter] to save" />
                        ...
                        <span class="input-group-text quantity_podomoro">
                            ...
                            <input style="width: 20px; border:none;" class="form-control " placeholder="Select a date"
                                id="datepicker-icon" value="{{ date('Y-m-d') }}" name="select_date">
            ...
            @foreach ($tasks as $task)
                <div class="border-0 rounded-2 bg-white mb-2  @if ($task->isCompleted()) d-none @endif">
                    <div class="input-group input-group-flat " style="min-height: 46px;">
                        <span class="input-group-text  ">
                            <form action="{{ route('task.completed', $task->id) }}" method="POST">
                                ...
                                <button class="form-check-input m-0" type="checkbox"
                                    style="border-color: {{ $task->getPriorityColor() }}">
                                </button>
                        ...
                        <span class="input-group-text border border-start-0">
                            <a href="{{ route('countdown.show', $task->id) }}" class="link-secondary" title="Play"
                                data-bs-toggle="tooltip">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="#ff6b6b"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-nowrap">
                                    @for ($i = 1; $i <= $task->quantity_podomoro; $i++)
                                        ...
                                        <div class="mr-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 27" fill="none" stroke="#ff8585" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"
                                                class="icon icon-tabler icons-tabler-outline icon-tabler-clock-hour-3">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                <path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
                ...
                <div class="modal modal-blur fade" id="taskModal{{ $task->id }}" tabindex="-1"
                ...
                @if ($task->isCompleted())
                    <div class="border-0 rounded-2 bg-white mb-2 active  ">
                        <div class="border-0 rounded-2 bg-white mb-2  ">
                            <div class="input-group input-group-flat border border-success rounded-2 "
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-nowrap">
                                            @for ($i = 1; $i <= $task->quantity_podomoro; $i++)
                                                ...
                                                <div class="mr-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 27" fill="none" stroke="#ff8585"
                                ...
                                <span class="border border-start-0 input-group-text  link-secondary">
                                    <form action="/home/delete/{{ $task->id }}" method="post">
                                        ...
                                        <button style=" background: #fff;" class="border-0 btn-ghost px-2 "
                                            type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                height="24" viewBox="0 0 24 24" fill="#ff1f1f"
